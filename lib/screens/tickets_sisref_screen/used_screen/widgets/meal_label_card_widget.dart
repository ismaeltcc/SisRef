...
class MealLabelCardWidget extends StatefulWidget {
  ...
  final String statusMeal;
  final Color statusColor;

  @override
  State<MealLabelCardWidget> createState() => _MealLabelCardWidgetState();
}

class _MealLabelCardWidgetState extends State<MealLabelCardWidget> {
  @override
